			...
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="row">
                            <div class="col-md-2">
                                <div id="colorlib-logo"><a href="index.html">CurrierGuide</a></div>
                            </div>
                            <div class="col-md-10 text-right menu-1">
                                <ul>
                                    ...
                                    <li><a href="news.html">Locations</a></li>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Contact ICT Faculty</h1>
				   					<h2><span><a href="index.html">Home</a> | <a href="luct.html">Luct</a> </span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
