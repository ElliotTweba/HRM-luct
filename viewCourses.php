			   	...
			   	<li style="background-image: url(images/blog-3.jpg);">
			   		...
			   		<div class="container-fluid">
						<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
									...
									$Code =  $_GET['code'];
									$Fname =  $_GET['Fname'];?>
				   					<?php echo'<h1>LUCT COURSES<h2><span>'; 
									echo"$Code"; echo' Courses </span></h2>';?>
				   				</div>
				   			</div>
				   		</div>
						<?php
						...
						try {
							...
							$query="select * from course WHERE fullname='$Fname'";
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						<h2>faculty of <?php echo "$Fname";?></h2>
					</div>
				</div>
				<div class="row">
					<?php
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								...
								<p><a href="#" class="btn-learn">Edit | Del </a></p>
							</div>
						</div>
					</div>
					<?php 
